...
//Options
  ...
  $('.options-toggle').on('click', function() {
    ...
    if ($(this).hasClass("toggle-off")) {
      ...
      $(this, '.option-value').text("ON").addClass("option-value");
      if (id === "auto-reset-toggle") {
        aRestart = true;
      }
      if (id === "audio-alarm-toggle") {
        aAlarm = true;
      }
      if (id === "visual-alarm-toggle") {
        vAlarm = true;
      }
    } 
      ...
      $(this, '.option-value').text("OFF").addClass("option-value");
      if (id === "auto-reset-toggle") {
        aRestart = false;
      }
      if (id === "audio-alarm-toggle") {
